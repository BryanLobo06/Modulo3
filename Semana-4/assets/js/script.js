...
/**
 * Función para exportar datos (mejora adicional)
 */
function exportarDatos() {
    const datos = recuperarDeLocalStorage();
    if (datos) {
...
/**
 * Función para importar datos (mejora adicional)
 */
...
console.log('Script cargado - Interfaz Interactiva con Persistencia de Datos'); 